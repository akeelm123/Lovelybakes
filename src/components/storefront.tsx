...
export function Storefront({ products, preview = true, content = defaultContent, orderingRule = defaultOrderingRule, commerceEnabled = false, checkoutEnabled = false }: { products: Product[]; preview?: boolean; content?: SiteContent; orderingRule?: OrderingRule; commerceEnabled?: boolean; checkoutEnabled?: boolean }) {
