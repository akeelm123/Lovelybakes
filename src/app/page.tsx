...
export default async function Home() {
  ...
  return <Storefront products={products} preview={preview} content={content} orderingRule={orderingRule} commerceEnabled={preview || checkoutEnabled} checkoutEnabled={checkoutEnabled} />;
}
